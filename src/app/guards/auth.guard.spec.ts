...
describe('AuthGuard', () => {
  ...
  it('should return true when there is a jwt key at localstorage', inject([AuthGuard], (guard: AuthGuard) => {
  ...
  it('should return false when there is not any jwt key at localstorage', inject([AuthGuard], (guard: AuthGuard) => {
    spyOn(localStorage, 'getItem').and.callFake((key) => {
      return null;
    });
